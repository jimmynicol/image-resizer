...
Img = (function() {
  ...
  Img.prototype.generateVersion = function() {
    ...
    this.logger.log('acquiring lock');
    ...
    redis.lock(this._lockKey())
      .catch(function(err) {
        ...
        redis.setLock(_this._lockKey())
          .done(function() {
            _this.logger.log('redis lock set');
      ...
      .then(function(msg) {
        ...
        return _this.findVersion(deferred);
      });
  ...
  Img.prototype._processVersion = function(deferred) {
    ...
    this.logger.log('_processVersion');
    ...
    s3.getFile(this.originalS3Path())
      ...
      .then(function(res){
        ...
        console.log('s3download', res.statusCode);
      ...
      .done(function(res){
        ...
        console.log('s3upload', res.statusCode);
